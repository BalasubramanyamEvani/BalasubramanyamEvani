...
Software Engineer. Pretending I know what I’m doing since forever.

### ⚙️ Focus areas
- **Systems engineering** (breaking things and making them work again)
- **Distributed systems** (aka chaos in containers)
- **Platform infrastructure** (terraforming my life one YAML at a time)
- **CI/CD** (continuous suffering & debugging)
- **Containerization** (wrapping problems in boxes)
...
_(API go vroom · bots do stuff · occasionally take over the world 😎)_

### 💬 Languages & tools
**Go · Python · Linux · Containers**  
_(Will code in anything… even if it hates me back 🐸)_

---

## 🧠 Engineering Philosophy

- Prefer simple, boring solutions that scale  
- Reliability > cleverness  
- Automate early, observe everything  
